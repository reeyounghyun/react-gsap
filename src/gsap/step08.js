...
const Step08 = () => {
    ...
    <section className='w-full pb-[100vh] relative mx-auto my-0 bg-black overflow-hidden border-4 border-red-600'>
        <div ref={el => sectionRefs.current[0] = el} className='w-full h-[110vh]'>
        ...
        <div ref={el => sectionRefs.current[1] = el} className='w-full h-[110vh]'>
        ...
        <div ref={el => sectionRefs.current[2] = el} className='w-full h-[110vh]'>
        ...
        <div ref={el => sectionRefs.current[3] = el} className='w-full h-[110vh]'>
        ...
        <div ref={el => sectionRefs.current[4] = el} className='w-full h-[110vh]'>
        ...
        <div ref={el => sectionRefs.current[5] = el} className='w-full h-[110vh]'>
            <div className="bg-[#000] text-white rounded-t-[50px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)] overflow-hidden">
                <ul className="flex justify-between">
                    <li className="w-1/2">
                        <a href="/">
